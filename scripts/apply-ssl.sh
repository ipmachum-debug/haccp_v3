...
CERT_PATH="/etc/letsencrypt/live/millioai.com"
...
sed -i 's|ssl_certificate /etc/nginx/ssl/haccpone-selfsigned.crt;|ssl_certificate /etc/letsencrypt/live/millioai.com/fullchain.pem;|g' /etc/nginx/conf.d/haccpone.conf
sed -i 's|ssl_certificate_key /etc/nginx/ssl/haccpone-selfsigned.key;|ssl_certificate_key /etc/letsencrypt/live/millioai.com/privkey.pem;|g' /etc/nginx/conf.d/haccpone.conf
...
echo ""
echo "✅ SSL 적용 완료!"
echo "   https://millioai.com"
echo "   https://app.millioai.com"
echo "   https://millioai.com → https://millioai.com (301)"
