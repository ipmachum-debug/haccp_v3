      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-900">
            ...
            {/* 1행: 공정유형(고정너비) + 프로파일명(넓게) + 시간(좁게) */}
            <div className="flex gap-3 mb-3">
              <div className="w-[150px] shrink-0">
                <Label className="text-xs font-medium mb-1 block">공정 유형</Label>
              ...
              <div className="flex-1">
                <Label className="text-xs font-medium mb-1 block">프로파일명 <span className="text-red-500">*</span></Label>
                <Input
              ...
              <div className="w-[90px] shrink-0">
                <Label className="text-xs font-medium mb-1 block">시간(분) <span className="text-red-500">*</span></Label>
                <Input
                  type="number"
            ...
            <div className="flex gap-3 mb-3">
              <div className="w-[200px] shrink-0">
                <Label className="text-xs font-medium mb-1 block">공정 그룹 (선택)</Label>
