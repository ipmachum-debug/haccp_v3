...
const CosmeticDashboard = lazy(() => import("./pages/cosmetic/CosmeticDashboard"));
...
const CosmeticLabelList = lazy(() => import("./pages/cosmetic/CosmeticLabelList"));
...
// Phase Y-12: Environmental Monitoring (환경 모니터링 EMP — FSSC / Codex)
const FoodEnvironmentalMonitoring = lazy(() => import("./pages/environmentalMonitoring/FoodEnvironmentalMonitoring"));
...
const CosmeticBmrDetail = lazy(() => import("./pages/cosmetic/CosmeticBmrDetail"));
const CosmeticBmrIpc = lazy(() => import("./pages/cosmetic/CosmeticBmrIpc"));
...
function Router() {
  return (
    <Suspense fallback={
      ...
      {/* Phase C Part 2 (2026-04-14): 세금계산서 (팝빌 설정은 모달로 내장) */}
      ...
      <Route path="/dashboard/accounting/hr" component={lazy(() => import("@/pages/accounting/HRManagement"))} />
      ...
      <Route path="/dashboard/cosmetic/dashboard" component={CosmeticDashboard} />
      ...
      {/* Phase Y-12 — Environmental Monitoring (환경 모니터링 EMP) */}
      <Route path="/dashboard/food/environmental-monitoring" component={FoodEnvironmentalMonitoring} />
      ...
      <Route path="/dashboard/cosmetic/label/:id" component={CosmeticLabelDetail} />
      <Route path="/dashboard/cosmetic/release" component={CosmeticReleaseList} />
      <Route path="/dashboard/cosmetic/release/:id" component={CosmeticReleaseDetail} />
