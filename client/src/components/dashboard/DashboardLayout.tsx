...
function DashboardLayoutContent({
  ...
  const accountingMenuItems = [
    ...
    { icon: Settings2, label: "팝빌 설정", path: "/dashboard/accounting/popbill-settings", roles: ["super_admin", "admin"] },
