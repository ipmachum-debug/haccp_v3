...
export default function CostAnalysis() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="productFilter">{`${L("product")}`}</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="statusFilter">{`${L("batch")} 상태`}</Label>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{`${L("batch")}별 원가 비교`}</CardTitle>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle>{`${L("material")}별 원가 비중`}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{`${L("material")}별 원가 상세`}</CardTitle>
            <CardDescription>{`${L("material")}별 총 원가 (단위: 원)`}</CardDescription>
          </CardHeader>
          <CardContent>
