...
export default function ProductManagement() {
  ...
  return (
    ...
    <div className="space-y-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">{`${L("product")} 관리`}</h1>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{`${L("product")} 추가`}</DialogTitle>
              <DialogDescription>
                새로운 제품 정보를 입력합니다.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                <Label htmlFor="productCode">{`${L("product")}코드 *`}</Label>
                <Input
                  id="productCode"
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  ...
                  placeholder={`${L("product")}에 대한 설명을 입력하세요.`}
                  rows={3}
                />
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{`${L("product")} 목록`}</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{`${L("product")}코드`}</TableHead>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{`${L("product")} 수정`}</DialogTitle>
            <DialogDescription>
              제품 정보를 수정합니다.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="edit-productName">{`${L("product")}명 *`}</Label>
              <Input
                id="edit-productName"
                value={formData.productName}
                onChange={(e) =>
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-productCode">{`${L("product")}코드`}</Label>
              <Input
                id="edit-productCode"
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{`${L("product")} 삭제`}</AlertDialogTitle>
            <AlertDialogDescription>
