        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedRecord && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm text-muted-foreground">{L("batch")} 코드</Label>
                ...
                <div>
                  <Label className="text-sm text-muted-foreground">{L("product")} 코드</Label>
