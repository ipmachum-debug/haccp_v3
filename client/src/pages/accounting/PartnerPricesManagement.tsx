  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Card>
          <CardContent className="py-4">
            <p className="text-xs text-muted-foreground">{`${L("material")}`}</p>
            <p className="text-2xl font-bold text-blue-600">{stats.materials}건</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-4">
            <p className="text-xs text-muted-foreground">{`${L("product")}`}</p>
            ...
            <div>
              ...
              <Select value={targetFilter} onValueChange={setTargetFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="material">{`${L("material")}만`}</SelectItem>
                  <SelectItem value="product">{`${L("product")}만`}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
      ...
      {/* ═══ AI 조정 미리보기 Dialog ═══ */}
      {/* ═══ AI 미리보기 Dialog (2026-04-19 분해: _partnerPrices/PartnerPricesDialogs) ═══ */}
      <AiPreviewDialog
        open={aiPreviewOpen}
