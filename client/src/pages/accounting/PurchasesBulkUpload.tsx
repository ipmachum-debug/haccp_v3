...
export default function PurchasesBulkUpload() {
  return (
    <DashboardLayout>
      <PurchasesBulkUploadContent />
    </DashboardLayout>
  );
}

function PurchasesBulkUploadContent() {
  ...
  const bulkMutation = trpc.haccpIntegration.bulkCreatePurchases.useMutation();
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" onClick={() => navigate('/dashboard/accounting/purchases/list')} className="h-8 px-2">
      ...
      {step === 'upload' && (
        <Card className="p-8">
          <div className="text-center space-y-6">
            <div className="mx-auto w-20 h-20 rounded-full bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center">
      ...
      {step === 'result' && uploadResult && (
        <Card className="p-8 text-center space-y-6">
          ...
          <div>
            <h2 className="text-xl font-bold">매입 일괄 등록 완료</h2>
          ...
          <div className="flex justify-center gap-3">
            <Button onClick={() => navigate('/dashboard/accounting/purchases/list')} className="gap-2">
              매입 조회로 이동
            </Button>
