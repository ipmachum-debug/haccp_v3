      ...
      <div className="space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="turnover" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>{`${L("material")}별 재고 회전율 분석`}</CardTitle>
                <CardDescription>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <SortableHeader label={L("material")} sortKey="materialName" currentSort={pg.sort} onSort={pg.handleSort} />
  ...
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>{`${L("material")}별 재고 현황`}</CardTitle>
