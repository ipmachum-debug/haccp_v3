              ...
              <table className="w-full border-collapse border border-gray-300 text-sm">
                <thead>
                  <tr className="bg-blue-50">
                    ...
                    <th className="border border-gray-300 px-2 py-2">{`${L("product")}명`}</th>
                  ...
                  {rows.map((row, idx) => (
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-1 py-1">
                        <Input className="h-8 text-sm border-0" value={row.productName} onChange={(e) => updateRow(idx, "productName", e.target.value)} placeholder={`${L("product")}명`} />
                      </td>
                      <td className="border border-gray-300 px-1 py-1">
