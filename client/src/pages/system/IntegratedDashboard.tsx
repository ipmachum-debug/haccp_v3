...
import ProductionEfficiency from "../production/ProductionEfficiency";
import InventoryTrend from "../inventory/InventoryTrend";
import PurchaseProposalHistory from "../inventory/PurchaseProposalHistory";
