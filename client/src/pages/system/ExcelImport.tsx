            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-3 text-sm">
                  <SummaryCard label={L("material")} count={preview.summary.materials} icon="🏭" />
                  <SummaryCard label={L("product")} count={preview.summary.products} icon="📦" />
