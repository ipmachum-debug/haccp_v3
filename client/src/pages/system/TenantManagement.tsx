                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800">
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-blue-600 dark:text-blue-400">배치</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="sync_products" className="text-sm font-normal cursor-pointer">제품</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="sync_materials"
                        ...
                        />
                        <Label htmlFor="sync_materials" className="text-sm font-normal cursor-pointer">원재료</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="sync_orders"
