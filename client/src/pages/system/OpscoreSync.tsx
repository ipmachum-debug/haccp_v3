                  ...
                  <td className="px-4 py-3 text-center">
                    {editingId === m.id ? (
                      ...
                      <div className="flex flex-wrap gap-1 justify-center">
                        ...
                        {m.sync_products === 1 && <span className="bg-indigo-50 text-indigo-700 px-1.5 py-0.5 rounded text-xs">{L("product")}</span>}
                        {m.sync_materials === 1 && <span className="bg-indigo-50 text-indigo-700 px-1.5 py-0.5 rounded text-xs">{L("material")}</span>}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border shadow-sm p-5">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-gray-500">{L("product")}</span><span className="font-bold">{statusData?.haccpProducts || 0}건</span></div>
              </div>
            </div>
            <div className="bg-white rounded-xl border shadow-sm p-5">
              <h4 className="font-semibold text-gray-700 mb-3 flex items-center gap-2">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-gray-500">{L("product")}</span><span className="font-bold">{statusData?.opscoreProducts || 0}건</span></div>
              </div>
            </div>
          </div>
