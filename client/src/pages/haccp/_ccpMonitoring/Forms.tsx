/**
 * CCPMonitoring 분해 — 폼 컴포넌트 + 헬퍼.
 *  - clCheck / ClBadge      한계기준 비교 헬퍼
 *  - EquipmentFormDialog    설비 등록/수정 다이얼로그
 *  - EquipmentBasedCcpForm  설비 기반 CCP 폼
 *  - EquipmentCcpSettingsForm 설비별 CCP 한계기준 설정
 */
...
import {
  Settings, Cpu, Loader2, Save, RotateCcw, Plus, Edit, Trash2,
  AlertTriangle, ShieldCheck, ShieldAlert, CheckCircle, XCircle,
} from "lucide-react";
...
export function clCheck(value: string | number | undefined, min: number | null | undefined, max: number | null | undefined): "ok" | "warn" | "na" {
...
export function ClBadge({ status }: { status: "ok" | "warn" | "na" }) {
...
// ============================================================
export function EquipmentBasedCcpForm() {
...
// ============================================================
export function EquipmentCcpSettingsForm({
  equipment,
  ccpTypeDescription,
  onSaved,
  processGroup,
