...
export default function HazardAnalysis({ embedded, ..._ }: { embedded?: boolean; [key: string]: any } = {}) {
  ...
  if (isLoading) {
    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{`${L("product")} 선택`}</CardTitle>
        ...
        <CardContent>
          ...
          >
            <SelectTrigger className="w-[300px]">
              <SelectValue placeholder={`${L("product")} 선택`} />
            </SelectTrigger>
            <SelectContent>
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{`${L("process")} 단계`}</TableHead>
          ...
          <form onSubmit={handleCreate}>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="productId">{`${L("product")} *`}</Label>
              ...
              <div className="grid gap-2">
                <Label htmlFor="processStep">{`${L("process")} 단계 *`}</Label>
                <Input
                  id="processStep"
                  name="processStep"
        ...
        <Dialog open={!!editingHazard} onOpenChange={() => setEditingHazard(null)}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <form onSubmit={handleUpdate}>
              ...
              <div className="grid gap-4 py-4">
                <div className="grid gap-2">
                  <Label htmlFor="edit-processStep">{`${L("process")} 단계 *`}</Label>
                  <Input
                    id="edit-processStep"
                    name="processStep"
