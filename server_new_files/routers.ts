...
import { hSystemSettings, hInventoryLots, hInventoryTransactions, hMfFlavors } from "../drizzle/schema";
...
export const appRouter = router({
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        try {
          ...
          try {
            ...
            const fileKey = `haccp-reports/batch-${input.batchId}-${timestamp}.pdf`;
  ...
  batchSchedule: router({
   ...
   product: router({
    list: protectedProcedure.query(async ({ ctx }) => {
      ...
      return await getAllProducts(ctx.user.tenantId);
    }),
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
    ...
    create: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const { createProduct } = await import("./db.js");
        const { shelfLifeMonths, ...rest } = input;
        const shelfLifeDays = shelfLifeMonths ? shelfLifeMonths * 30 : undefined;
        return await createProduct({ ...rest, shelfLifeDays, tenantId: ctx.user.tenantId });
      }),
    update: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const shelfLifeDays = shelfLifeMonths ? shelfLifeMonths * 30 : undefined;
        return await updateProduct(id, { ...rest, shelfLifeDays });
      }),
    delete: adminProcedure
      .input(z.object({ id: z.number() }))
      .mutation(async ({ input, ctx }) => {
        const { deleteProduct } = await import("./db.js");
        return await deleteProduct(input.id, ctx.user.tenantId);
      }),
    ...
    generateCode: protectedProcedure
      .query(async () => {
        ...
        return await generateProductCode();
      }),
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        for (let i = 0; i < input.products.length; i++) {
          try {
            ...
            const { shelfLifeMonths, unitPrice, ...rest } = product;
            const shelfLifeDays = shelfLifeMonths ? shelfLifeMonths * 30 : undefined;
            ...
            errors.push({
              row: i + 1,
              productName: input.products[i].productName,
  ...
  inventory: router({
    ...
    generateCode: protectedProcedure
      .query(async () => {
        ...
        return await generateMaterialCode();
      }),
  ...
  mfReport: router({
    ...
    create: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        return await createMfReport(input);
      }),
  ...
  notification: router({
    ...
    markAsResolved: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        await markNotificationAsResolved(input.notificationId);
        return { success: true };
      }),
    ...
    countsByType: protectedProcedure.query(async ({ ctx }) => {
      ...
      return await getNotificationCountsByType(ctx.user.id);
    }),
    ...
    getStatistics: protectedProcedure
      ...
      .query(async ({ input }) => {
        ...
        return await getNotificationStatistics(input?.startDate, input?.endDate);
      }),
    ...
    deleteOldReadNotifications: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const deletedCount = await deleteOldReadNotifications(input.days);
    ...
    archiveByType: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const result = await archiveNotificationsByType(input.type);
  ...
  material: router({
    ...
    list: protectedProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        // WHERE 조건 구성
        const conditions = [eq(hMaterials.tenantId, ctx.user.tenantId)];
        
        if (input?.search) {
          conditions.push(
            or(
              like(hMaterials.materialName, `%${input.search}%`),
              like(hMaterials.materialCode, `%${input.search}%`)
            )!
          );
        }
        
        if (input?.category) {
          conditions.push(eq(hMaterials.category, input.category));
        }
        
        if (input?.kind) {
          conditions.push(eq(hMaterials.kind, input.kind));
        }
        
        // P0 FIX: 기본적으로 활성 데이터만 조회 (소프트 삭제된 데이터 제외)
        if (input?.isActive !== undefined) {
          conditions.push(eq(hMaterials.isActive, input.isActive));
        } else {
          conditions.push(eq(hMaterials.isActive, 1));
        }
  ...
  supplier: router({
    getAll: protectedProcedure.query(async ({ ctx }) => {
      ...
      return await getAllSuppliers(ctx.user.tenantId);
    }),
    getById: publicProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
    ...
    create: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        return await createSupplier({ ...input, tenantId: ctx.user.tenantId });
      }),
    update: adminProcedure
      .input(
        z.object({
    ...
    delete: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        return await deleteSupplier(input.id, ctx.user.tenantId);
      }),
  ...
  approval: router({
    ...
    list: protectedProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getApprovalRequests({ ...input, tenantId: ctx.user.tenantId || 1 });
      }),
  ...
  accounting: router({
    ...
    getCategories: protectedProcedure.query(async () => {
      ...
      return await getAllCategories(ctx.user.tenantId);
    }),
  ...
  partners: router({
    ...
    list: protectedProcedure
      ...
      .query(async ({ input }) => {
        ...
        return await getAllPartners(input);
      }),
  ...
  accountingDaily: router({
    ...
    execute: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        return await executeDailyClose({
  ...
  haccpIntegration: router({
    ...
    getAllPurchases: adminProcedure
      ...
      .query(async ({ input }) => {
        ...
        return await getAllPurchases(input);
      }),
    ...
    createPurchase: adminProcedure
      .input(
        z.object({
          ...
          partnerId: z.number(),
          itemName: z.string(),
          materialId: z.number().optional(), // 원재료 ID
          quantity: z.number(),
    ...
    getAllSales: adminProcedure
      ...
      .query(async ({ input }) => {
        ...
        return await getAllSales(input);
      }),
