...
import * as supplierDb from "../../db/haccp/supplierAudit";
...
export const supplierAuditRouter = router({
  ...
  createSupplier: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const id = await supplierDb.createSupplier(ctx.tenantId, input);
      return { id };
    }),
  ...
  getSupplier: tenantRequiredProcedure
    ...
    .query(async ({ input, ctx }) => {
      return await supplierDb.getSupplierById(ctx.tenantId, input.id);
    }),
  ...
  updateSupplier: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const { id, ...data } = input;
      await supplierDb.updateSupplier(ctx.tenantId, id, data);
      return { success: true };
    }),
  ...
  deleteSupplier: tenantRequiredProcedure
    .input(z.object({ id: z.number() }))
    .mutation(async ({ input, ctx }) => {
      await supplierDb.deleteSupplier(ctx.tenantId, input.id);
      return { success: true };
    }),
  ...
  createAudit: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const id = await supplierDb.createSupplierAudit(ctx.tenantId, {
        ...input,
  ...
  getAudit: tenantRequiredProcedure
    .input(z.object({ id: z.number() }))
    .query(async ({ input, ctx }) => {
      return await supplierDb.getSupplierAuditById(ctx.tenantId, input.id);
    }),
  ...
  updateAudit: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      await supplierDb.updateSupplierAudit(ctx.tenantId, id, updateData);
      return { success: true };
    }),
  ...
  deleteAudit: tenantRequiredProcedure
    .input(z.object({ id: z.number() }))
    .mutation(async ({ input, ctx }) => {
      await supplierDb.deleteSupplierAudit(ctx.tenantId, input.id);
      return { success: true };
    }),
  ...
  createEvaluation: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const id = await supplierDb.createSupplierEvaluation(ctx.tenantId, {
        ...input,
        overallScore,
  ...
  getEvaluation: tenantRequiredProcedure
    .input(z.object({ id: z.number() }))
    .query(async ({ input, ctx }) => {
      return await supplierDb.getSupplierEvaluationById(ctx.tenantId, input.id);
    }),
  ...
  updateEvaluation: tenantRequiredProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const { id, ...data } = input;
      await supplierDb.updateSupplierEvaluation(ctx.tenantId, id, data);
      return { success: true };
    }),
  ...
  deleteEvaluation: tenantRequiredProcedure
    .input(z.object({ id: z.number() }))
    .mutation(async ({ input, ctx }) => {
      await supplierDb.deleteSupplierEvaluation(ctx.tenantId, input.id);
      return { success: true };
    }),
  ...
  getDashboard: tenantRequiredProcedure
    .query(async ({ ctx }) => {
      return await supplierDb.getSupplierDashboard(ctx.tenantId);
    }),

  getUpcomingAudits: tenantRequiredProcedure
    .input(z.object({ limit: z.number().optional() }))
    .query(async ({ input, ctx }) => {
      return await supplierDb.getUpcomingAudits(ctx.tenantId, input.limit);
    }),
});
