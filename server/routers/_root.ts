...
// ── core-mes (Layer 2) ── (2026-04-30: Phase Y-2-0-b — cross-cutting quality 도메인)
...
export const appRouter = router({
  ...
  // ── core-mes (Layer 2 cross-cutting) ── (2026-04-30: Phase Y-2-0-b)
  //    변경관리 / 부적합 / CAPA / 감사 — 모든 industry 공통
  ...coreMesRouterMap,
