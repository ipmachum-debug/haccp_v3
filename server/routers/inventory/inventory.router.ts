...
export const inventoryRouter = router({
    ...
    getLotsByMaterialFefo: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getLotsByMaterialFefo({ materialId: input.materialId, tenantId: ctx.user.tenantId });
      }),
    ...
    getLotsByMaterialId: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getInventoryLotsByMaterialId(input.materialId, ctx.user.tenantId);
      }),
    ...
    getLowStock: tenantRequiredProcedure
      .query(async ({ ctx }) => {
        ...
        return await getLowStockMaterials(ctx.user.tenantId);
      }),
    ...
    getSlowMovingItems: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getSlowMovingItems(input.thresholdDays, ctx.user.tenantId);
      }),
    ...
    getTurnoverSettings: tenantRequiredProcedure.query(async ({ ctx }) => {
      ...
      return await getInventoryTurnoverSettings(ctx.user.tenantId);
    }),
    ...
    checkAndCreateTurnoverAlerts: tenantRequiredProcedure.mutation(async ({ ctx }) => {
      ...
      return await checkAndCreateTurnoverAlerts(ctx.user.tenantId);
    }),
    ...
    getPurchaseProposalHistory: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getPurchaseProposalHistory({ ...input, tenantId: ctx.user.tenantId });
      }),
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const [lot] = await db.select().from(hInventoryLots).where(
          and(
            ...
            eq(hInventoryLots.tenantId, ctx.user.tenantId)
          )
        );
        if (!lot) {
    ...
    getUsagePattern: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await calculateUsagePattern(input.materialId, input.days, ctx.user.tenantId);
      }),
    ...
    predictStockout: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await predictStockout(input.materialId, ctx.user.tenantId);
      }),
    ...
    recommendPurchase: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await recommendPurchase(input.materialId, ctx.user.tenantId);
      }),
    ...
    getAllPurchaseRecommendations: tenantRequiredProcedure.query(async ({ ctx }) => {
      ...
      return await getAllPurchaseRecommendations(ctx.user.tenantId);
    }),
    ...
    checkLowStockPrediction: tenantRequiredProcedure.query(async ({ ctx }) => {
      ...
      return await checkLowStockPrediction(ctx.user.tenantId);
    }),
    ...
    createLowStockNotifications: tenantRequiredProcedure.mutation(async ({ ctx }) => {
      ...
      return await createLowStockNotifications(ctx.user.tenantId);
    }),
    ...
    getById: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getMaterialById(input.id, ctx.user.tenantId);
      }),
    ...
    update: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const { id, ...data } = input;
        return await updateMaterial(id, { ...data, tenantId: ctx.user.tenantId });
      }),
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        for (let i = 0; i < input.materials.length; i++) {
          try {
            ...
            const materialCode = await generateMaterialCode(ctx.user.tenantId);
    ...
    getProductOutboundHistory: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getProductOutboundHistory(input || {}, ctx.user.tenantId);
      }),
    ...
    getProductAvailableForRelease: tenantRequiredProcedure
      .query(async ({ ctx }) => {
        ...
        return await getProductAvailableForRelease(ctx.user.tenantId);
      }),
    ...
    cancelProductOutbound: workerProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        return await cancelProductOutbound(input.outboundId, ctx.user.id, ctx.user.tenantId);
      }),
    ...
    getProductOutboundTrend: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getProductOutboundTrend(input, ctx.user.tenantId);
      }),
    ...
    getProductTurnoverAnalysis: tenantRequiredProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        return await getProductTurnoverAnalysis(input, ctx.user.tenantId);
      }),
    ...
    getProductOutboundStats: tenantRequiredProcedure
      .query(async ({ ctx }) => {
        ...
        return await getProductOutboundStats(ctx.user.tenantId);
      })
});
